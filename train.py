...
# Load Dataset
train_data, validation_data, test_data = object_detector.DataLoader.from_csv('/home/ashish/Documents/Python/salads_ml_use.csv')
...
tflite_eval_result = model.evaluate_tflite('android.tflite', test_data)
